...
export class ProductoPage implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private router:Router, private productoService:ProductoService, private pedidoDetalleService:PedidoDetalleService) { 
